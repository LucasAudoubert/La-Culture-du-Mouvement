    ...
    function culture_mouvement_all_assets()
    {
        ...
        if (is_page_template('page-contact.php')) {
            ...
            wp_enqueue_script('tabs-js', get_template_directory_uri() . '/assets/js/tabs.js', array(), _S_VERSION, true);
        }
        ...
        // ... reste du code enqueue ...

        // Calendrier Assets (Scripts externes)
        ...
        // Tes fichiers (Vérifie bien que les dossiers correspondent !)
