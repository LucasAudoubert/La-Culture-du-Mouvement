...
<<<<<<< style
    ...
    wp_enqueue_style('avis-style', get_template_directory_uri() . '/assets/css/avis.css', array(), null);
    wp_enqueue_style('faq-style', get_template_directory_uri() . '/assets/css/faq.css', array(), null);
    ...
    wp_enqueue_script('hero-slider-js', get_template_directory_uri() . '/assets/js/slider.js', array(), null, true);
    wp_enqueue_script('burger-js', get_template_directory_uri() . '/assets/js/burger.js', array(), null, true);
=======
    wp_enqueue_script('contact-form-js', $uri . '/assets/js/contact-form.js', array(), _S_VERSION, true);
...
// ✅ Always runs — mapConfig is always injected
wp_localize_script('map-init', 'mapConfig', array(
    'nom'       => 'Culture Mouvement',
    'adresse'   => $adresse,
    'rue'       => $rue,
