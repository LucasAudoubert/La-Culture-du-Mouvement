...
wp_localize_script('map-init', 'mapConfig', array(
    ...
    wp_enqueue_style('calendrier-style', $uri . '/assets/css/calendrier-style.css', array(), _S_VERSION);
    wp_enqueue_script('calendrier-script', $uri . '/assets/js/calendrier-script.js', array('fullcalendar-ical'), _S_VERSION, true);
